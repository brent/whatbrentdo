...
const BlogSection = () => (
  <div className={styles.blogSection}>
    ...
    <p><a href="https://whatbrentsay.com">whatbrentsay</a> is a self-published Gatsby.js + Wordpress blog that doesn't have a schedule. It’s mostly about tech but sometimes other things, too.</p>
  </div>
)
  ...
  return (
    <section className={styles.personalProjectsSection}>
      <div className={styles.personalProjectsHeader}>
        ...
        <p>Here's a couple worth mentioning.</p>
      </div>
      <ul>
        <li>
          <PersonalProjectSubsection project={projectsData[2]}>
            ...
            <img className={styles.gradientProjectImg1} src="img/gradient-entry.png" />
            ...
            <p>Apple's new Journal app in iOS 17 looks like it does the same thing as Gradient so this project is officially retired.</p>
        ...
        <li>
          <PersonalProjectSubsection project={projectsData[0]}>
            ...
            <img className={styles.wbpProjectImg2} src="img/whatbrentplay-admin.png" />
            <p>I wrote <a href="https://old.whatbrentsay.com/2020/08/26/byte-sized-reviews-2-years-later">a two year retrospective</a> about it for my blog if you’re interested in learning more about its progress. Speaking of...</p>
          </PersonalProjectSubsection>
        </li>
      </ul>
